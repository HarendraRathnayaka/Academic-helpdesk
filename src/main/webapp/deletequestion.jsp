...
<body>
	...
	<table class="tablecon">
		<tr><th colspan="2">Delete Your Question</th></tr>
		<tr>
			<td>Question ID</td>
		...
		<tr>
			...
			<td><input type="text" name="Ucode" value="<%= Uniquecode %>" readonly></td>
		</tr>
		<tr>
		<td>Your Email</td>
		<td><input type="text" name="Usermail" value="<%= Useremail %>" readonly></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Your Question</td>
		<td><textarea name="Question" rows="6" cols="50" readonly><%= Question%></textarea></td>
	</tr>
		
	</table>
	<br>
	<input class="bt3" type="submit" name="delete" value="Delete My Question">
	</form>
	</div>
